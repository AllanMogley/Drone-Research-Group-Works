...
for i in x:
    ...
    if next_pass <= T2ls8:
        ...
        print(predictor.get_next_pass(KALRO Mwea Kirogo farm, next_pass, max_elevation_gt=30))
...
for j in x2:
    ...
    if next_pass2 <= T2s2A:
        ...
        print(predictor.get_next_pass(KALRO Mwea Kirogo farm, next_pass2, max_elevation_gt=30))
